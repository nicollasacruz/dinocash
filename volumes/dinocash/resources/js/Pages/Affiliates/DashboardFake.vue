...
const link = "https://dinofeliz.io/ref/" + affiliateLink;
  ...
  <AffiliateLayout>
    ...
    >
      ...
      <CurrencyBox
        ...
        negative
      />
      <CurrencyBox label="Lucro do dia" :value="636.46" />
      <CurrencyBox label="Lucro em 30 dias" :value="4456.88" />
      <CurrencyBox label="Lucro Total" :value="4456.88" />
      <CurrencyBox label="Lucro CPA do dia" :value="2689" />
      <CurrencyBox label="Lucro CPA 30 dias" :value="11560" />
      <CurrencyBox label="Lucro CPA Total" :value="11560" />
      <TextBox label="Convidados" :value="632"></TextBox>
      <TextBox label="Convidados CPA" :value="578"></TextBox>
    </div>
