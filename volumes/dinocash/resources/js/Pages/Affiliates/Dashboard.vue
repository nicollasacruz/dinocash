    ...
    <AffiliateLayout>
        ...
        <div class="grid grid-cols-5 gap-x-3 mt-10">
            <TextBox
                ...
                class="col-span-3"
                :value="'http://dinocash.io/afiliado/' + 1"
            >
                <template #action>
                    <button class="btn min-h-[2rem] h-[2rem] bg-yellow-500 text-black hover:text-white">Copiar o link</button>
                </template>
            </TextBox>
            <div class="grid grid-cols-2 gap-x-2 col-span-2 mt-4">
                ...
                <CurrencyBox
                    ...
                    value="200"
                ></CurrencyBox>
                <button class="btn bg-yellow-500 text-black hover:text-white col-span-2 mt-1 uppercase">Solicitar saque de comissões</button>
            </div>
        </div>
    </AffiliateLayout>
</template>
