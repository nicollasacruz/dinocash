...
<template>
    ...
    >
        ...
        <div class="w-full mx-auto mt-auto">
            ...
            <div
                class="mx-auto mb-[10vh] text-xl font-menu text-white text-center"
            >
    ...
    >
        ...
        >
            <div class="flex w-full h-full">
                ...
                <div class="flex-1 grid grid-cols-3 gap-x-1 md:gap-x-3 font-menu md:text-3xl mt-5">
                    <div>Usuário</div>
                    <div>Distância</div>
                    <div class="mb-3">Prêmio</div>
                    <template v-for="(user, i) in 10">
                        <div class="flex">
                            <img class="w-7" v-if="i < 3" :src="getTrophy(i)" />
