...
const props = defineProps(["withdraws", "totalAmount", "totalToday"]);
const { withdraws, totalToday, totalAmount } = props;
const rows = computed(() =>
    props.withdraws.data.map((withdraw) => {
        return {
            ...withdraw,
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex gap-x-4 my-4">
            ...
            <div>
                <div class="font-bold text-white uppercase mb-1">Status</div>
                <select
                    type="text"
        ...
        <Paginator :data="props.withdraws" class="mt-4" />
    </AuthenticatedLayout>
</template>
