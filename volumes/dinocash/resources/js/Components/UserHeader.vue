<template>
    <template v-if="logged">
        <div
            ...
            <div v-if="logged" class="flex flex-1 lg:justify-normal lg:col-start-2 xl:col-start-3 items-center">
                <bars3-icon @click="emit('toggle')"
            ...
            <div class="flex sm:flex-1 items-center justify-end gap-x-1 sm:gap-x-2 lg:col-end-11 xl:col-end-12 pr-3">
                <div
                ...
                <Link class="font-bold ml-2 mr-1 py-1 px-3 lg:mr-0 lg:ml-0 text-xs lg:text-base text-red-700 rounded-md border border-red-700"
                ...
                <img class="w-5 sm:w-7 lg:w-14 mt-2 lg:mt-0 ml-2" :src="leave" />
                </Link>
            </div>
        </div>
    </template>
    <div v-else class="bg-roxo flex justify-center items-center h-20 py-6 px-1 sm:px-2 py-2">
        <div class="flex gap-x-3">
            <Link :href="route('login')">
            <div class="user-button py-2 px-5 lg:px-10 lg:text-base lg:py-3 items-center flex">
                Login
            </div>
            </Link>
